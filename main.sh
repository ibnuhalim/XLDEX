...
clear;clear;clear
  ...
  # // Banner
echo -e "${BLUE}----------------------------------------------------------${NC}"
echo -e " WELCOME TO XD STORE SCRIPT ${BLUE}(${NC}${green}Stable Edition${NC}${BLUE})${NC}"
echo -e " PROSES PENGECEKAN IP ADDRESS ANDA !!"
echo -e "${BLUE}----------------------------------------------------------${NC}"
echo -e " ›AUTHOR : ${green} XD STORE ® ${NC}${BLUE}(${NC}${green}V 0.0${NC}${BLUE})${NC}"
echo -e " ›TEAM : XD STORE ${BLUE}(${NC} 2024 ${BLUE})${NC}"
echo -e "${BLUE}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/ibnuhalim/XLDEX/main/"
...
clear
izinsc="https://raw.githubusercontent.com/ibnuhalim/permision/main/izin"
# USERNAME
rm -f /usr/bin/user
...
TIMES="10"
CHATID="8225573254"
KEY="8719321789:AAGcdGjYsVTESWCGAh4X55UVjiaqC7ef99o"
...
<b> XD TOOLS SCRIPT  </b>
<code>────────────────────</code>
<i>Notifications From XDstore AutoSc</i>
...
wget -q https://raw.githubusercontent.com/ibnuhalim/XLDEX/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
